...
describe('CdkCloudFrontLambdaS3APIGatewaySQSStack', () => {
  describe('デフォルト構成 (SQSなし)', () => {
    const app = new cdk.App();
    const stack = new CdkCloudFrontLambdaS3APIGatewaySQSStack(
      app,
      'TestCdkCloudFrontLambdaS3APIGatewaySQSStack'
    );
  ...
  describe('SQS有効構成', () => {
    ...
    const stack = new CdkCloudFrontLambdaS3APIGatewaySQSStack(
      app,
      'TestCdkCloudFrontLambdaS3APIGatewaySQSStackWithSQS',
      {
        useSqs: true,
      }
    );
